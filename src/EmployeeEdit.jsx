...
export default class EmployeeEdit extends React.Component {
    ...
    loadData(){
        ...
        .then (data => {
            ...
            // data.employee.currentlyEmployed = data.employee.currentlyEmployed === true
    ...
    render(){
        if (!this.state.employee || !this.state.employee.name) {
            return <div>Loading...</div>; // Show loading indicator if data is not ready
        }
        return (
                    <Card>
                            ...
                            <Card.Text>
                                <Container fluid>
                                    <form name = "employeeUpdate" onSubmit={this.handleSubmit}>
                                        ...
                                        <Row>
                                            <Col md={2}>ID:</Col>
                                            <Col md="auto"><input type="text" name ="id" readOnly="readOnly" defaultValue={this.state.employee._id}></input> </Col>
                                        </Row> 
                                        <Row>
                                            <Col md={2}>Name:</Col>
                                        ...
                                        <Button type ="submit" variant="primary" size = "sm" className="my-3">Update Empployee</Button> <br/>
                                        <Alert 
